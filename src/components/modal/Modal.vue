<template>
  <div id="modal">
    ...
    <div class="modal__container" :class="Helper.modal.show ? 'animate__animated animate__zoomIn animate__faster' : ''">
      <div class="modal__container--title">
        <h3>{{Helper.modal.title}}</h3>
      </div>
